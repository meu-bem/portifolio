...
const aboutMeParapgraphs = [
  "Hi, I'm a young developer exploring the diverse worlds of technology for 4 years now, traveling from Back-end to Front-end, with many expeditions into the universe of Design.",
